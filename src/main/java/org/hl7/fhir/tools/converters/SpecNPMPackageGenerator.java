...
//  
  ...
  public void generate(String folder, String url, boolean forWeb, Date genDate, String pidRoot) throws Exception {
    ...
    NPMPackageGenerator npm = new NPMPackageGenerator(pidRoot+".core", Utilities.path(folder, pidRoot+".core.tgz"), "http://hl7.org/fhir", url, PackageType.CORE, ig, genDate, true, null);
...
//    npm.addFile(Category.RESOURCE, "ig-r4.json", bs.toByteArray());
    ...
    npm = new NPMPackageGenerator(pidRoot+".corexml", Utilities.path(folder, pidRoot+".corexml.tgz"), "http://hl7.org/fhir", url, PackageType.CORE, ig, genDate, true, null);
