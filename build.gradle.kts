...
dependencies {
    ...
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.utilities", "5.6.9")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.dstu2", "5.6.9")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.dstu2016may", "5.6.9")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.dstu3", "5.6.9")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.r4", "5.6.9")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.r5", "5.6.9")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.convertors", "5.6.9")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.validation", "5.6.9")
