...
dependencies {
    ...
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.utilities", "5.4.3-SNAPSHOT")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.dstu2", "5.4.3-SNAPSHOT")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.dstu2016may", "5.4.3-SNAPSHOT")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.dstu3", "5.4.3-SNAPSHOT")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.r4", "5.4.3-SNAPSHOT")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.r5", "5.4.3-SNAPSHOT")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.convertors", "5.4.3-SNAPSHOT")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.validation", "5.4.3-SNAPSHOT")
    ...
    implementation("es.weso", "schema_2.12", "0.1.91")
    ...
    implementation("es.weso", "converter_2.12", "0.1.91")
