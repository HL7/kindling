...
dependencies {
    ...
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.utilities", "5.5.4")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.dstu2", "5.5.4")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.dstu2016may", "5.5.4")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.dstu3", "5.5.4")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.r4", "5.5.4")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.r5", "5.5.4")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.convertors", "5.5.4")
    implementation("ca.uhn.hapi.fhir", "org.hl7.fhir.validation", "5.5.4")
